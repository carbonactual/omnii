...
## 2. Canonical Safeguard

The following distinction is immutable unless explicitly changed through constitutional amendment:
...
No future document may silently redefine these terms. Any change requires an explicit constitutional amendment and reconciliation across the corpus.

## 3. Constitutional Progression

```text
Architecture
    ↓
Universal Ecosystem Model
    ↓
Semantics
    ↓
Mathematics
...
OMNI
  = omnidirectional movement state
  = ecosystem movement pattern
  = directionally unconstrained becoming
```
...
ABBA may interpret constitutional doctrine, reason over dependencies, coordinate workflows, reconcile states, and assist legitimate action. ABBA remains subordinate to the constitutional architecture and does not replace it.
