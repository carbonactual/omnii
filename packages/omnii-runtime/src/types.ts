...
export interface Authority { id: string; subject: string; issuer?: string; scope: string[]; capabilities: string[]; constraints?: JsonObject; issued_at: string; expires_at?: string; revocable: boolean; revoked_at?: string; provenance?: JsonObject; }
