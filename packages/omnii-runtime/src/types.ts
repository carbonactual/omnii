...
export interface Relationship { id: string; type: string; source: string; target: string; direction: "directed" | "undirected"; status: string; effective_from?: string; effective_to?: string; authority: JsonObject; provenance: JsonObject; constraints?: JsonObject; metadata?: JsonObject; version?: string; }
